...
def calcular_media():
    ...
    if media_final >= 6:
        mensagem = f"Parabéns! Você foi aprovado com nota {media_final:.2f}"
    elif media_final >= 4:
        mensagem = f"Você ainda não foi aprovado! Sua nota foi {media_final:.2f}. Você terá a opção de fazer o IFA!!!"
    else:
        mensagem = f"Com a nota {media_final:.2f} você não foi aprovado! Veja pelo lado bom, você irá cursar a disciplina novamente semestre que vem!!!"
